@push('style')
    <style>
        ...
        background: #dccbe6 none repeat scroll 0 0;
        border-radius: 3px;
        color: #646464;
        font-size: 14px;
        margin: 0;
        ...
        .sent_msg p {
        background: #0473c3 none repeat scroll 0 0;
        border-radius: 3px;
        font-size: 14px;
        margin: 0; color:#fff;
        padding: 5px 10px 5px 12px;
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Chat</span></li>
            </ul>
        </div>
    </div>
                                    ...
                                    <div id="chat" class="msg_history">
                                        ...
                                        @forelse ($messages as $message)
                                            @php
                                                ...
                                                if($message->) 
                                                {
                                                    $checkappontimentstatus =Appointment::where('chat_code',$message->massege_code)->where('status','Reserved')->count();
                                                }*/
                                             @endphp 
                                            ...
                                            @endif
                                        @empty
                                            <h5 style="text-align: center;color:red"> There is no message to display</h5>
                                        @endforelse
                                    ...
                                    <div class="input_msg_write">
                                        <form wire:submit.prevent="sendMessage">
                                            <input onkeydown='scrollDown()' wire:model.defer="messageText" type="text"
                                                class="write_msg" placeholder="اwrite your message" />
